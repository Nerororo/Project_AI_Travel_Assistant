...
| 순수 경로 | 확정 | 부분 구현·검증 | WGS84 Coordinate·Haversine·Nearest Neighbor·고정 양 끝 경계 2-opt 구현 완료, 이동 시간 추정·기하 중앙값·메도이드·성능 회귀는 후속 작업 |
